...
<div class="periode-page">
    ...
    <form
        action="{{ route('periode-ami.store') }}"
        method="POST"
        id="periodeForm"
    >
        @csrf
